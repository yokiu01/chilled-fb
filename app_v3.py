# 춤마루 MVP v3 Streamlit (2025.09.18)
# 완전한 Streamlit 구현 버전 - 10개 질문, 8개 DNA 타입, 12개 기본동작 포함
...
dna_types = {
    "밈 장인": {
        ...
        "color": "#FF6B35",
        "video_file": "DNA Type/MemeMaster.mp4"
    },
    "무드 큐레이터": {
        "emoji": "✨",
        "title": "Mood Curator", 
        ...
        "color": "#A8E6CF",
        "video_file": "DNA Type/MoodCurator.mp4"
    },
    "갓생 플래너": {
        "emoji": "📋",
        ...
        "color": "#4ECDC4",
        "video_file": "DNA Type/PerfectPlanner.mp4"
    },
    "디테일 장인": {
        "emoji": "🔍",
        ...
        "color": "#B8860B",
        "video_file": "DNA Type/DetailArtisan.mp4"
    },
    "감성 필터": {
        "emoji": "💫",
        ...
        "color": "#DDA0DD",
        "video_file": "DNA Type/EmotionalFilter.mp4"
    },
    "인간 공명기": {
        "emoji": "🤝",
        ...
        "color": "#FF69B4",
        "video_file": "DNA Type/HumanResonator.mp4"
    },
    "파티 히어로": {
        "emoji": "🎉",
        "title": "Party Hero",
        ...
        "color": "#FFD700",
        "video_file": "DNA Type/PartyHero.mp4"
    },
    "흥 폭발러": {
        "emoji": "🚀",
        "title": "Fun Exploder",
        ...
        "color": "#FF4500",
        "video_file": "DNA Type/FunExplorer.mp4"
    }
}
...
expanded_actions = [
    {
        ...
        "video_file": "Expand/겹디딤.mp4"
    },
    {
        "name": "제자리돌기", 
        "description": "같은 자리에 서서 회전하는 동작",
        "video_file": "Expand/제자리돌기.mp4"
    },
    {
        "name": "이동하면서돌기",
        "description": "걸음을 옮기며 회전하는 동작", 
        "video_file": "Expand/이동하면서돌기.mp4"
    },
    {
        "name": "점프하면서돌기",
        "description": "뛰어오르며 회전하는 동작",
        "video_file": "Expand/점프하면서돌기.mp4"
    },
    {
        "name": "연풍대",
        "description": "바람에 흔들리는 버드나무처럼 원을 그리며 회전하는 동작",
        "video_file": "Expand/연풍대.mp4"
    },
    {
        "name": "치마채기",
        "description": "치마 자락을 들어 움직임을 강조하는 동작",
        "video_file": "Expand/치마채기.mp4"
    }
]
...
def show_result_page():
    ...
    try:
        ...
        st.info(f"{st.session_state.dna_result} 타입 전문가 시연 영상 (30초) - 업로드 예정")
...
def show_action_page():
    ...
    with col1:
        ...
        try:
            ...
            st.info(f"{action['name']} 시범 영상 (5초) - 업로드 예정")
    ...
    for action in expanded_actions:
        with st.expander(f"🎭 {action['name']}", expanded=False):
            ...
            try:
                ...
                st.info(f"{action['name']} 전문가 시연 영상 (5초) - 업로드 예정")
    ...
    for action in creative_actions:
        with st.expander(f"🚀 {action['name']}", expanded=False):
            ...
            try:
                ...
                st.info(f"{action['name']} 창작 시연 영상 (5초) - 업로드 예정")

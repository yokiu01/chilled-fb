...
basic_actions = [
    {
        ...
        "video_file": "basic-actions/left-right-bird.mp4"
    },
    {
        "name": "감기", 
...
expanded_actions = [
    {
        ...
        "video_file": "expanded-actions/crossed-step.mp4"
    },
    {
        "name": "제자리돌기", 
        "description": "같은 자리에 서서 회전하는 동작",
        "video_file": "expanded-actions/turn-in-place.mp4"
    },
    {
        "name": "이동하면서돌기",
        "description": "걸음을 옮기며 회전하는 동작", 
        "video_file": "expanded-actions/move-and-turn.mp4"
    },
    {
        "name": "점프하면서돌기",
        "description": "뛰어오르며 회전하는 동작",
        "video_file": "expanded-actions/jump-and-turn.mp4"
    },
    {
        "name": "연풍대",
        "description": "바람에 흔들리는 버드나무처럼 원을 그리며 회전하는 동작",
        "video_file": "expanded-actions/willow-turn.mp4"
    },
    {
        "name": "치마채기",
        "description": "치마 자락을 들어 움직임을 강조하는 동작",
        "video_file": "expanded-actions/skirt-lift.mp4"
    }
]
...
creative_actions = [
    ...
    },
    {
        ...
        "video_file": "creative-actions/passe.mp4"
    },
    {
        "name": "턴",
        "description": "몸을 축으로 삼아 위로 세워 회전하는 동작",
        "video_file": "creative-actions/turn.mp4"
    },
    {
        "name": "점프",
